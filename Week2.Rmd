...
We can analyze that via analyzing of UTF-code symbols. If the word contains symbols out of the that language code block, we can safely assume that this is a word in a different language.

We can use this table available online for different languages: http://www.utf8-chartable.de/unicode-utf8-table.pl?start=256&unicodeinhtml=dec

It takes some time, and is not really required for exploratory analysis, since the most popular words are written in Enlgish.
